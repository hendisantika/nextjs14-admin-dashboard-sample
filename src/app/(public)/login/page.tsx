                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            <div className="mb-4">

                                {
                                    !isOtpSent &&
                                    <>
                                        <p className="text-center text-lg   md:mt-0 mt-6 mb-12  font-semibold">Enter
                                            Email ID to Continue</p>
...

                                {
                                    isOtpSent && <>
                                        ...
                                        <p className="text-center text-lg   md:mt-0 mt-6   font-semibold">Enter verification
                                            code received on {loginObj.emailId}</p>
                                        <p className="text-center text-slate-500 mt-2 text-sm">Didn&apos;t receive mail?
                                            Check spam folder</p>
                            ...
                            <div className="mt-8">
                                ...
                                <button type="submit" className={`btn mt-2 w-full btn-primary`}>
                                    {loading && <span
                                        className="loading loading-spinner"></span>}{isOtpSent ? 'Verify' : 'Get Verification Code'}
                                </button>
                            </div>
                        </form>
                    </div>
