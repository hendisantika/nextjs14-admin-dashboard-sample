        ...
        <div className="drawer-side z-30 overflow-hidden">
            ...
            <div className="dropdown bottom-0 absolute dropdown-top w-80 ">
                <div tabIndex={0} role="button" className="btn w-full bg-base-100 text-left justify-start ">
                    ...
                    {user.name}<ChevronUpIcon className="w-4 " /></div>
                <ul tabIndex={0}
                    className="dropdown-content visible w-52 px-4 z-[1]  menu  shadow bg-base-200 rounded-box ">
                    <li className=""><Link href={'/settings/billing'}><BookmarkSquareIcon className="w-4 " />Bill
                        History</Link></li>
                    <div className="divider py-2 m-0"></div>
                    <li onClick={() => logoutUser()}><a className=" "><ArrowUpOnSquareIcon className="w-4 " />Logout</a>
                    </li>
                </ul>
            </div>
        </div>
